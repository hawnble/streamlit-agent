...
# 사용자 입력을 처리합니다.
if prompt := st.chat_input(placeholder="가볍고 빠른 노트북 추천해줄래? 무게는 1.6kg 이하면 괜찮을거 같아!"):
    ...
    llm = ChatOpenAI(
        temperature=0.3, model="gpt-3.5-turbo-0613", openai_api_key=openai_api_key, streaming=True
    )
